    ...
    montarHome(){
        ...
        <main class="servicos container">
            <article class="servico radius">
                <a href="cardapio.html"><img src="resources/img/servicos.jpg" alt="Pratos da casa"></a>
                <div class="inner">
            ...
            <article class="servico radius">
                <a href="cardapio.html"><img src="resources/img/tele_entrega.jpg" alt="Tele entrega de comida"></a>
                <div class="inner">
            ...
            <article class="servico radius">
                <a href="contato.html"><img src="resources/img/eventos.jpg" alt="Eventos comemorativos com buffet"></a>
                <div class="inner">
